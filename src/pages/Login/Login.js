              ...
              xl:text-bold">Log in</h2>
                <div className="mt-12">
                    <div>
                        ...
                        <div className="mt-8">
                            <div className="flex justify-between items-center">
                                ...
                                <div>
                                    <NavLink to='/forgot' className="text-xs font-display font-semibold text-indigo-600 hover:text-indigo-800
                                  cursor-pointer">
                                        Forgot Password?
                                    </NavLink>
                                </div>
                        ...
                        <div className="mt-12">
                            <button type='submit' disabled={!formik.isValid} className="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                    ...
                    <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Don't have an account ? <NavLink to='/register' className="cursor-pointer text-indigo-600 hover:text-indigo-900">Sign up</NavLink>
                    </div>
                </div>
            </div>
        </form>

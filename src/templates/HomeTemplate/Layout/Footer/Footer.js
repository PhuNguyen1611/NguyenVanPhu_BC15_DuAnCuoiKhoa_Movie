...
export default function Footer(props) {
    ...
    return (
        <footer className="px-4 divide-y bg-coolGray-100 text-coolGray-800 bg-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4" style={{ color: 'rgb(24, 144, 255)' }}>
                    <div className="space-y-3 mr-4">
                        ...
                        <ul className="space-y-1 grid grid-cols-3">
                            ...
                            {arrHeThongRap.map((htr, index) => {
                                return <li key={index}>
                                    <a href="#"><img src={htr.logo} alt={htr.tenHeThongRap} style={{ width: '35px' }} /></a>
                                </li>
                            })}
                        </ul>
                    </div>
